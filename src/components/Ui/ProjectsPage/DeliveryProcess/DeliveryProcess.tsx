import { ClipboardCheck, FileCheck2, HardHat, Search } from "lucide-react";
import SlideUp from "@/src/components/Common/Animaation/SlideUp";

const STEPS = [
  { num: "01", icon: Search, title: "Site Survey", desc: "We assess the land and requirements" },
  { num: "02", icon: FileCheck2, title: "Design & Permits", desc: "Plans finalized, approvals secured" },
  { num: "03", icon: HardHat, title: "Construction", desc: "Skilled crews build to spec" },
  { num: "04", icon: ClipboardCheck, title: "Final Walkthrough", desc: "Quality checked, keys handed over" },
];
