...
const CERTIFICATIONS = [
  ...
  { icon: ShieldCheck, title: "ISO 9001:2015 Certified", org: "Quality Management Systems" },
  { icon: FileCheck2, title: "OSHA 30-Hour Certified Crews", org: "Occupational Safety & Health" },
  { icon: Users2, title: "Member, National Builders Association", org: "Industry Association" },
];
