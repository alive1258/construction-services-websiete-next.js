...
import { MapPin, Mail, PhoneCall, ArrowUp, ShieldCheck, Award } from "lucide-react";
import {
  FaFacebookF,
  FaInstagram,
  FaYoutube,
...
/* ================= CONSTANTS ================= */
// TODO: replace with the construction company's real contact details — same
...
// TODO: swap in the construction company's real social profile URLs
const SOCIAL_LINKS = [
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div>
              ...
              <p className="mt-4 text-brand-100/70 text-sm max-w-sm leading-relaxed">
                Building tomorrow&apos;s landmarks today. Trusted, reliable,
                and professional construction services for residential,
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-xs text-brand-100/60 text-center md:text-left">
            © {currentYear} <span className="text-gold-400">Constructa</span>.
            All rights reserved.
          </p>
